...
| [第二十八篇]([https://mp.weixin.qq.com/s/59i5_CmzVr19U32t2Ht2_Q](https://mp.weixin.qq.com/s/9zdsKi44uHXZ0HPSuJW9Ww))                                                                                                                                                | 75.`runtime.Caller(1)`获取调用者信息<br />76.`for`循环 + `select{}`语法                                         | [code](https://github.com/ibarryyan/golang-tips-100/tree/master/code/code_27) | 函数调用栈、`select{}` |
| DOING                                                                                                                                                                                                     |                                                                                                |                                                                              |                           |
