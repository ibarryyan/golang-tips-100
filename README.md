...
| [第一篇](https://mp.weixin.qq.com/s/2suBNq6RFN1INarY5pTkpA)                                                                                                                                                  | [code](https://github.com/ibarryyan/golang-tips-100/tree/master/code/code_01) | 1.函数返回值屏蔽<br /><br/>2.context继承特性<br/>3.禁止main函数退出<br/>4.map值的遍历次序函数<br/>`关键词：context、map`                      | 4   | ⭐   |
...
| [第二十九篇](https://mp.weixin.qq.com/s/cgjk4zxBeTLUbgL3n2yJqA)                                                                                                                                                | [code](https://github.com/ibarryyan/golang-tips-100/tree/master/code/code_29) | 77.可变类型比较<br/><br/>78.Slice 最大值与最小值<br/><br/>79.Map 转换为 Slice<br/><br/>80.Map 合并<br/>`关键词：新版内置函数`               | 3   | ⭐⭐  |
| [第三十篇](https://mp.weixin.qq.com/s/gpDDtAd_1lXmCMpXMqgNyw)                                                                                                                                                 | [code](https://github.com/ibarryyan/golang-tips-100/tree/master/code/code_30) | 81.切片共享底层数组<br/><br/>82.获取Go函数的注释<br/>`关键词：抽象语法树、slice`                                                         | 2   | ⭐⭐⭐ |
| DOING                                                                                                                                                                                                     |                                                                               |                                                                                                                 |     |     |
